...
{
    std::cout << "\033[31mClapTrap Constructor has been called\033[0m" << std::endl;
}
...
{
    std::cout << "\033[31mClapTrap Copy constructor has been called\033[0m" << std::endl;
    *this = other;
}
...
ClapTrap::~ClapTrap()
{
    std::cout << "\033[31mClapTrap Destructor has been called\033[0m" << std::endl;
}
